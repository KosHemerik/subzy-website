...
export default function FAQHero({ onSearch }) {
  ...
  return (
    <section className="hero-bg py-16 pb-24 text-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-xl shadow-lg focus:outline-none focus:ring-2 focus:ring-secondary border-none text-gray-800"
