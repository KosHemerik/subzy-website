...
/**
 * Login Hero Section
 * Contains the login form with a styled hero background
 */
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Welkom terug bij Subzy
            </h1>
            <p className="text-lg text-blue-100 mb-8 max-w-md">
              Log in op uw klantportaal om uw aanvragen te bekijken, documenten te uploaden en uw voortgang te volgen.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start gap-6 text-white/80">
              ...
              <div className="flex items-center">
                <i className="fa-solid fa-lock text-secondary text-xl mr-3" />
                <span className="text-sm">Privacy gegarandeerd</span>
              </div>
            </div>
